    ...
    if(difficultyChoice==1){
        ...
        for(int i=0;i<10;i++){
            ...
            if(playerChoice==secretNumber){
                ...
                if(choicesLeft==0){
                cout<<"\nYou couldn't find secret number, it was "<<secretNumber<<", You lose!!\n\n";
                cout<<"Play the game again to win!!!\n\n"; 
                }
            }
        }
    }
    else if(difficultyChoice==2){cout<<"\nYou have 7 choicesfor finding the secret number between 1 and 100.";
        int choicesLeft=7;
        for(int i=0;i<7;i++){
            cout<<"\n\nEnter the number: ";
            cin>>playerChoice;
        ...
        cout<<"\nYou have 5 choicesfor finding the secret number between 1 and 100.";
        int choicesLeft=5;
        for(int i=0;i<5;i++){
            cout<<"\n\nEnter the number: ";
            cin>>playerChoice;
